...
// Google Play, Twitter/X, Spotify Community, and Reddit are intentionally
// absent - see the comment on ACTIVE_SOURCES in @/lib/domain/spotify for why
// none of them can reliably return real data for a third-party tool like
// this one.
